...
import { IDevices, Devices } from 'app/shared/model/devices.model';
...
describe('Service Tests', () => {
    describe('Devices Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Devices', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        model: 1,
            ...
            it('should delete a Devices', async () => {
